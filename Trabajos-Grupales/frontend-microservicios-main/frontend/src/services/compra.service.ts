...
export const CartService = {
  ...
  async add(evento_id: number, cantidad: number): Promise<CartItem | null> {
    try {
  ...
  async pay(itemId: number): Promise<void> {
